...
var inventory_data: InventoryResource = null: set = set_inventory_data
...
func _ready() -> void:
	...
	if get_parent() == get_tree().root:
		var test_inventory_data := InventoryResource.new()
...
func set_inventory_data(new_inventory_data: InventoryResource) -> void:
...
func _on_tooltip_requested(ui_item: UIItem) -> void:
	var description: String = ItemDatabase.get_item_data(ui_item.item_unique_id).description
